...
if($table === "departments"){
  ...
  foreach($result as $row){
    echo "<tr>
            ...
            <td>
              <a href='includes/update.inc.php?id=".$row["category_id"]."&table=departments'>".$row["category_name"]."</a>
            </td>
  ...
  foreach($result as $row){
    echo "<tr>
            ...
            <td>
              <a href=includes/update.inc.php?id=".$row["building_id"]."&table=building>".$row["building_name"]."</a>
            </td>
  ...
  foreach($result as $row){
    echo "<tr>
            ...
            <td>
              <a href='includes/update.inc.php?id=".$row["speaker_id"]."&table=speakers'>".$row["speaker_name"]." - ".$row["speaker_surname"]."</a>
            </td>
  ...
  echo "<tr class='thead-light'><th>Nom</th><th>Implantation</th><th>Local</th><th>Département</th><th>Nombre d'inscrits</th><th>Inscrits/Favoris</th><th></th><tr>";
