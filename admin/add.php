...
if($_GET["table"] === "building"){
  ...
  echo "</select></div><div class='form-group col'><label for='event-building'>Local</label><select name='event-local' class='col-auto form-control' required><option disabled selected value> --- </option>";
  ...
  echo "</select></div><div class='form-group col'><label for='event-section'>Section</label><select name='event-section' class='col-auto form-control' required><option disabled selected value> --- </option>";
  ...
  <input required type='text' class='form-control' name='event-size' value='0' required><small>Laisser sur 0 s'il n'y a pas de limite de places</small></div><div class='form-group'><label for='event-section'>Conférencier</label><select name='event-conf' class='col-auto form-control' required><option disabled selected value> --- </option>";
  ...
  <input type='text' class='form-control' name ='name-room' id='name-room'></div><div class='col'><label for='event-local'>Implantation</label><select name='event-local' class='col-auto form-control'><option disabled selected value> --- </option>";
...
}elseif($_GET["table"] === "section"){
  echo "<div><ol class='breadcrumb'><li class='breadcrumb-item active'><a href='/jpof/admin/'>Accueil</a></li><li class='breadcrumb-item active'>Ajout d'une catégorie</li></ol></div><h1>Ajout d'une section</h1><form action='insert.php?table=section' method='POST'><div class='form-group'><label for='name-section'>Nom</label><input type='text' class='form-control' id='name-section' name='name-section'></div><div class='form-group'><label for='id-building'>Implantation</label><select name='id-building' class='col-auto form-control'><option disabled selected value> --- </option>";
