...
if(isset($_SESSION["token"]) && $_SESSION["isadmin"] == 0){
  ...
  echo "<h6 class='card-subtitle mb-2'>Pour pouvoir vous inscrire/ajouter cet événement à vos favoris, veuillez vous <a href='sign.php?set=signin'>connecter</a>.</h6>";
}
